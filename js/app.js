(() => {
    ...
    const dictionary = {
        ...
        ua: {
            ...
            "home.text": "Привіт! Я креативна починаюча фронтенд розробниця. Спеціалізуюсь на розробці адаптивних, надійних та кросбраузерних сайтів. Цікавлюсь JavaScript та React.",
        ...
        ru: {
            ...
            "home.titleSpan": "Плюта.",
            "home.text": "Привет! Я креативная начинающий фронтенд-разработчица. Специализируюсь на разработке адаптивных, надежных и кроссбраузерных сайтов. Интересуюсь JavaScript и React.",
