(() => {
    ...
    function initSliders() {
        if (document.querySelector(".portfolio")) new core(".portfolio__slider", {
    ...
    const dictionary = {
        en: {
            ...
            "home.subtitle": "My name is",
            "home.title": "Anastasiia",
            "home.titleSpan": "Pliuta.",
            "home.text": "Hello! I am a creative junior front-end developer. Specializing in the develop of adaptive, reliable and cross-browser sites. Proficient in JavaScript and React.",
            "skills.subtitle": "Skills",
            "skills.title": "Specialized in",
            "itemSkills1.title": "HTML",
            "itemSkills1.text": "The HyperText Markup Language is the standard markup language for documents designed to be displayed in a web browser. In a simple language, this is the internal structure of the website.",
            "itemSkills2.title": "CSS",
            "itemSkills2.text": "Cascading Style Sheets is a style sheet language used for describing the presentation of a document written in a markup language such as HTML. In simple language, this is the appearance of a website.",
            "itemSkills3.title": "JavaScript",
            "itemSkills3.text": 'JavaScript is a programming language that is one of the core technologies of the World Wide Web. JavaScript was initially created to "make web pages alive". In simple language, JS is responsible for the interactivity on the website.',
            "portfolio.subtitle": "Portfolio",
            "portfolio.title": "My works",
            "portfolio.subtitle": "Portfolio",
            "itemPortfolio1.title": "Farmgrow - responsive, cross-browser and semantic landing page.",
            "itemPortfolio2.title": "Your School - responsive, cross-browser and semantic landing page.",
            ...
            "itemContent.button": "Get in touch"
        },
        ua: {
            "header.home": "Головна",
            "header.skills": "Навики",
            "header.portfolio": "Портфоліо",
            "header.contact": "Контакти",
            "button.resume": "Резюме",
            "home.subtitle": "Mене звати",
            "home.title": "Анастасія",
            "home.titleSpan": "Плюта.",
            "home.text": "Привіт! Я креативний починаючий фронтенд розробник. Спеціалізуюсь на розробці адаптивних, надійних та кросбраузерних сайтів. Цікавлюсь JavaScript та React.",
            "skills.subtitle": "Навики",
            "skills.title": "Спеціалізуюсь на",
            "itemSkills1.title": "HTML",
            "itemSkills1.text": "Стандартизована мова розмітки документів для перегляду веб-сторінок у браузері.  Простою мовою - це внутрішня структура сайту.",
            "itemSkills2.title": "CSS",
            "itemSkills2.text": "Каскадні таблиці стилів — це спеціальна мова стилю сторінок, написаних на мові розмітки даних, наприклад HTML, що використовується для опису їхнього зовнішнього вигляду. Простою мовою - це зовнішній вигляд сайту.",
            "itemSkills3.title": "JavaScript",
            "itemSkills3.text": 'JavaScript — це мова програмування, яка є однією з основних технологій Всесвітньої павутини. JavaScript спочатку був створений, щоб "оживити веб-сторінки". Простими словами, JS відповідає за інтерактивність на сайті.',
            "portfolio.subtitle": "Портфолio",
            "portfolio.title": "Mої роботи",
            "itemPortfolio1.title": "Farmgrow - адаптивна, кросбраузерна та семантична сторінка криптовалют.",
            "itemPortfolio2.title": "Your School - адаптивна, кросбраузерна та семантична сторінка онлайн школи.",
            ...
            "itemContent.button": "Напишіть мені"
        },
        ru: {
            "header.home": "Главная",
            ...
            "button.resume": "Резюме",
            "home.subtitle": "Mеня зовут",
            "home.title": "Анастасия",
            "home.titleSpan": "Плюта.",
            "home.text": "Привет! Я креативный начинающий фронтенд-разработчик. Специализируюсь на разработке адаптивных, надежных и кроссбраузерных сайтов. Интересуюсь JavaScript и React.",
            "skills.subtitle": "Навыки",
            "skills.title": "Специализируюсь на",
            "itemSkills1.title": "HTML",
            "itemSkills1.text": "Стандартизированный язык разметки документов для просмотра веб-страниц в браузере. Простым языком – это внутренняя структура сайта.",
            "itemSkills2.title": "CSS",
            "itemSkills2.text": "Каскадные таблицы стилей – это специальный язык стиля страниц, написанных на языке разметки данных, например HTML, используемый для описания их внешнего вида. Простым языком – это внешний вид сайта.",
            "itemSkills3.title": "JavaScript",
            "itemSkills3.text": 'JavaScript – это язык программирования, который является одной из основных технологий Всемирной паутины. JavaScript изначально был создан для того, чтобы "оживить веб-страницы". Простыми словами, JS отвечает за интерактивность на сайте.',
            "portfolio.subtitle": "Портфолиo",
            "portfolio.title": "Mои работы",
            "itemPortfolio1.title": "Farmgrow - адаптивная, кроссбраузерная и семантическая страница криптовалют.",
            "itemPortfolio2.title": "Your School - адаптивная, кроссбраузерная и семантическая страница онлайн школы.",
            ...
            "itemContent.button": "Напишите мне"
        }
    };
